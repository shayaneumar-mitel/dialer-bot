...
/**
 * Implementation of the Dialer Messaging Extension configuration page
 */
export const DialerMessagingExtensionMessageExtensionConfig = () => {
    ...
    return (
        <Provider theme={theme} styles={{ height: "100vh", width: "100vw", padding: "1em" }}>
            <Flex fill={true}>
                <Flex.Item>
                    <div>
                        <Header content="Dialer Messaging Extension configuration" />
                        <Checkbox
                            label="On or off?"
                            toggle
                            checked={onOrOff}

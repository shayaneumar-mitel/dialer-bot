# Dialer Messaging Extension Bot - `dialerMessagingExtensionBot`
...
3. Give the bot a handle (ex: `dialerMessagingExtensionBot`), choose your subscription and resource group
4. For the messaging endpoint, use this: `https://dilaeryome.azurewebsites.net/api/messages`
